...
import com.khorn.terraincontrol.handler.SpawnHandler;
...
public class TerrainControl {
	...
	public static final List<SpawnHandler> SPAWN_HANDLERS = new ArrayList<SpawnHandler>();
	...
	/**
	 * @see TerrainControlEngine#firePopulationEndEvent(LocalWorld, Random, boolean, ChunkCoordinate)
	 */
	public static void firePopulationEndEvent(LocalWorld world, Random random, boolean villageInChunk,
	                                          ChunkCoordinate chunkCoord) {
		engine.firePopulationEndEvent(world, random, villageInChunk, chunkCoord);
	}

	/**
	 * @see TerrainControlEngine#firePopulationStartEvent(LocalWorld, Random, boolean, ChunkCoordinate)
	 */
	public static void firePopulationStartEvent(LocalWorld world, Random random, boolean villageInChunk,
	                                            ChunkCoordinate chunkCoord) {
	 ...
	 */
	public static boolean fireResourceProcessEvent(Resource resource, LocalWorld world, Random random,
	                                               boolean villageInChunk, int chunkX,
	                                               int chunkZ) {
